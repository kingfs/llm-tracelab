...
type UserEdges struct {
	...
	loadedTypes [1]bool
	namedTokens map[string][]*APIToken
}
...
func (_m *User) NamedTokens(name string) ([]*APIToken, error) {
...
func (_m *User) appendNamedTokens(name string, edges ...*APIToken) {
	if _m.Edges.namedTokens == nil {
		_m.Edges.namedTokens = make(map[string][]*APIToken)
	}
	if len(edges) == 0 {
		_m.Edges.namedTokens[name] = []*APIToken{}
	} else {
