...
type UserQuery struct {
	...
	withNamedTokens map[string]*APITokenQuery
...
func (_q *UserQuery) WithNamedTokens(name string, opts ...func(*APITokenQuery)) *UserQuery {
	query := (&APITokenClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if _q.withNamedTokens == nil {
		_q.withNamedTokens = make(map[string]*APITokenQuery)
	}
