...
func (_u *DatasetUpdate) SetNillableUpdatedAt(v *time.Time) *DatasetUpdate {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
...
func (_u *DatasetUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *DatasetUpdate {
...
func (_u *DatasetUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(dataset.Table, dataset.Columns, sqlgraph.NewFieldSpec(dataset.FieldID, field.TypeString))
	...
	_spec.Node.Schema = _u.schemaConfig.Dataset
...
// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (_u *DatasetUpdateOne) SetNillableUpdatedAt(v *time.Time) *DatasetUpdateOne {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (_u *DatasetUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *DatasetUpdateOne {
	_u.modifiers = append(_u.modifiers, modifiers...)
	return _u
}
...
func (_u *DatasetUpdateOne) sqlSave(ctx context.Context) (_node *Dataset, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`dao: missing "Dataset.id" for update`)}
	}
